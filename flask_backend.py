...
@app.route('https://danielliu122.github.io/openAI_Chatbot_basic/templates/chatbot.html')
def home():
    return render_template("chatbot.html")

@app.route('https://danielliu122.github.io/openAI_Chatbot_basic/templates/chat', methods=['POST'])
def chat():
    global chat_log
